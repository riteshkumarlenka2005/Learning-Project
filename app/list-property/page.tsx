              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {formData.maushiAvailable && (
                    <div>
                      <Label htmlFor="maushiCost">Maushi Service Cost (per person/month)</Label>
            ...
            {currentStep === 6 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Upload high-quality photos of your property</p>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-yellow-700 space-y-1">
                    ...
                    <li>• Take photos during daytime for better lighting</li>
                    <li>• Show the exterior and any common areas</li>
