      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Find Experienced <span className="text-purple-600">Maushi Services</span>
          </h1>
          <p className="text-lg text-gray-600 mb-6">
            Cooking की tension नहीं! Experienced Maushi aunties से मिलेगा homestyle खाना
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card className="text-center p-4">
            <CardContent>
              ...
              <div className="text-sm text-gray-600">Verified Maushi</div>
            </CardContent>
          </Card>
          <Card className="text-center p-4">
            <CardContent>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">{maushiProviders.length} Maushi Services Available</h2>
